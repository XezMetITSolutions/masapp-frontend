...
const defaultSettings: BusinessSettings = {
  basicInfo: {
    ...
    subdomain: 'demo',
    businessType: 'cafe',
    description: 'Geleneksel lezzetler, ev yapımı tatlılar, taze kahveler ve özel yemeklerle sıcak aile ortamında hizmet veriyoruz.',
    slogan: 'Lezzetin Adresi',
    address: 'Erenler / SAKARYA',
    phone: '0536 912 76 67',
    email: 'demo@masapp.com',
    website: 'https://www.masapp.com',
    wifiPassword: 'MASAPP2025',
    workingHours: 'Pazartesi - Cuma: 08:00 - 22:00\nCumartesi - Pazar: 09:00 - 23:00',
    directionsLink: 'https://maps.google.com/direction',
