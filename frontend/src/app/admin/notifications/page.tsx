  ...
  const notifications: Notification[] = [
    {
      ...
      metadata: {
        restaurantId: 'rest-1',
        actionUrl: '/admin/payment-errors/err-1'
      }
    },
    {
      id: 'notif-2',
      type: 'success',
      priority: 'medium',
      title: 'Yeni İşletme Onaylandı',
      message: 'Burger King işletmesi başarıyla onaylandı ve aktif edildi.',
      recipient: {
        type: 'restaurant',
        id: 'rest-2',
        name: 'Burger King'
      ...
      metadata: {
        restaurantId: 'rest-2',
        actionUrl: '/admin/restaurants/rest-2'
      }
    },
    {
      id: 'notif-3',
      ...
      channel: 'email',
      status: 'sent',
      scheduledAt: '2024-03-16T23:00:00Z',
    ...
    },
    {
      ...
      priority: 'urgent',
      title: 'Sistem Hatası',
      message: 'Veritabanı bağlantı hatası tespit edildi. Acil müdahale gerekli.',
      recipient: {
        type: 'admin',
        name: 'Admin Panel'
      },
      channel: 'sms',
      status: 'delivered',
      sentAt: '2024-03-15T07:45:00Z',
      readAt: '2024-03-15T07:50:00Z',
    ...
    },
    {
      ...
      message: 'Ahmet Yılmaz kullanıcısı Pizza Palace için onaylandı.',
      recipient: {
        type: 'user',
        id: 'user-1',
        name: 'Ahmet Yılmaz'
      ...
      channel: 'email',
      status: 'delivered',
      sentAt: '2024-03-15T06:30:00Z',
      createdAt: '2024-03-15T06:30:00Z',
      createdBy: 'Admin User',
      metadata: {
        userId: 'user-1',
        restaurantId: 'rest-1',
        actionUrl: '/admin/user-approvals/app-1'
      }
    },
    {
      id: 'notif-6',
      ...
      message: 'Sushi Master işletmesinin aboneliği 3 gün sonra dolacak.',
      recipient: {
        type: 'restaurant',
        id: 'rest-3',
        name: 'Sushi Master'
      ...
      channel: 'email',
      status: 'pending',
      scheduledAt: '2024-03-18T09:00:00Z',
      createdAt: '2024-03-15T05:00:00Z',
      createdBy: 'System',
      metadata: {
        restaurantId: 'rest-3',
        actionUrl: '/admin/subscriptions/sub-3'
      }
    }
  ];
