...
export default function PaymentErrorsManagement() {
  ...
  const paymentErrors: PaymentError[] = [
    ...
    },
    {
      ...
      last4: '1234',
      attemptCount: 1,
      firstAttempt: '2024-03-15T09:15:00Z',
      lastAttempt: '2024-03-15T09:15:00Z',
      nextRetry: '2024-03-17T09:00:00Z',
      status: 'pending',
      notes: 'Kart güncelleme talebi gönderildi'
    },
    {
      id: 'err-3',
      ...
      last4: '5678',
      attemptCount: 2,
      firstAttempt: '2024-03-10T16:45:00Z',
      lastAttempt: '2024-03-10T17:30:00Z',
      nextRetry: '2024-03-12T16:00:00Z',
      status: 'resolved',
      resolution: 'Otomatik olarak çözüldü',
    ...
    },
    {
      ...
      owner: 'Fatma Özkan',
      email: 'fatma@coffeecorner.com',
      phone: '+90 535 777 8888',
      plan: 'Premium',
      amount: 4980,
      currency: 'TRY',
      errorCode: 'fraud_detected',
      errorMessage: 'Dolandırıcılık tespit edildi',
      errorType: 'fraud_detected',
      paymentMethod: 'card',
      last4: '9999',
      attemptCount: 1,
      firstAttempt: '2024-02-28T11:20:00Z',
      lastAttempt: '2024-02-28T11:20:00Z',
      status: 'cancelled',
      resolution: 'Dolandırıcılık nedeniyle iptal edildi',
      resolvedAt: '2024-02-28T12:00:00Z',
      resolvedBy: 'Admin User',
      notes: 'Kart sahibi ile doğrulama yapılamadı'
    },
    {
      id: 'err-5',
      ...
      owner: 'Can Yılmaz',
      email: 'can@pizzacorner.com',
      phone: '+90 537 111 2233',
      plan: 'Basic',
      amount: 2490,
      currency: 'TRY',
      errorCode: 'card_declined',
      errorMessage: 'Kart reddedildi - Genel hata',
      errorType: 'card_declined',
      paymentMethod: 'card',
      last4: '1111',
      attemptCount: 5,
      firstAttempt: '2024-03-05T08:00:00Z',
      lastAttempt: '2024-03-09T15:45:00Z',
      nextRetry: '2024-03-11T08:00:00Z',
      status: 'failed',
      notes: 'Maksimum deneme sayısına ulaşıldı, manuel müdahale gerekli'
    }
  ];
