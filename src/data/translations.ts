...
export const translations: { [key: string]: { en: string; de: string; tr: string } } = {
  ...
  'satışlarınızı %300 artırın!': {
    ...
    de: 'Steigern Sie Ihren Umsatz um 300%!',
    tr: 'satışlarınızı %300 artırın!'
  },
  'Rakiplerinizi geride bırakın.': {
    en: 'Leave your competitors behind.',
    de: 'Lassen Sie Ihre Konkurrenten hinter sich.',
    tr: 'Rakiplerinizi geride bırakın.'
  },
  'Hemen Bizi Arayın': {
    en: 'Call Us Now',
    de: 'Rufen Sie uns jetzt an',
    tr: 'Hemen Bizi Arayın'
  },
  ...
  'Güvenli Ödeme Sistemi': {
    ...
    de: 'Sicheres Zahlungssystem',
    tr: 'Güvenli Ödeme Sistemi'
  },
  ...
  '%300 Verimlilik Artışı': {
    en: '300% Productivity Increase',
    de: '300% Produktivitätssteigerung',
  ...
  '7/24 Telefon Desteği': {
    ...
    de: '24/7 Telefon-Support',
    tr: '7/24 Telefon Desteği'
  },
  'Beyaz Etiket Çözümü': {
